...
function createParty() {
    ...
    // UPDATED: Pass the config when creating a new Peer
    try { peer = new Peer(generateRandomId(), peerConfig); } catch (err) { console.error('[PeerLogic] Failed to create Peer object.', err); return; }
...
function joinParty(hostPeerId) {
    ...
    try {
        console.log('[PeerLogic] Creating new Peer with config');
